class Cube:
   ...
   def bt(self):
      self.cubies[0], self.cubies[1], self.cubies[9], self.cubies[15], self.cubies[19], self.cubies[18], self.cubies[10], self.cubies[4], self.cubies[23], self.cubies[22], self.cubies[21], self.cubies[20] = self.cubies[19], self.cubies[18], self.cubies[10], self.cubies[4], self.cubies[0], self.cubies[1], self.cubies[9], self.cubies[15], self.cubies[20], self.cubies[21], self.cubies[22], self.cubies[23]
